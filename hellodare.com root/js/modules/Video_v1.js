            ...
            try {
                ...
                playerInstance.ready().then(async () => {
                    ...
                    const handlePlay = () => {
                        ...
                        if (this.player) {
                            // console.log(`[Player Event ${this.id}] Play detected, ensuring timeupdate listeners are correct.`);
                            this.player.off('timeupdate'); // Remove ALL previous timeupdate listeners
                            this.player.on('timeupdate', handleTimeUpdate);     // Add back end simulation
                            this.player.on('timeupdate', handleProgressUpdate); // Add back progress/time update
                        }
                    };
